            ...
            if ([self validateTextField:accessoryTf.text] == YES) {
                ...
                if (fUpdatedString >= [i2iControl.min doubleValue] && fUpdatedString <= [i2iControl.max doubleValue]) {
                        ...
                        for (UITableViewCell *cell in i2iTableView.visibleCells) {
                            ...
                            for (UIView *view in [cell.contentView subviews]) {
                                ...
                                if ([view isKindOfClass:[UITextField class]]) {
                                    ...
                                    if (view == activeInputBox) sumOfInput += [[NSString stringWithFormat:@"%.3f", fUpdatedString] doubleValue];
                                    else sumOfInput += [[NSString stringWithFormat:@"%.3f", [textField.text doubleValue] / 100] doubleValue];
                        ...
                        if (sumOfInput > 1) {
                            ...
                            if (sumOfInput == 1) i2iTableView.sectionFooterHeight = 0.1f;
