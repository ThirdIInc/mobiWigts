...
-(void)readVal {
    ...
    SChartRadialDataPoint *dataPoint1 = [[SChartRadialDataPoint alloc] init];
    dataPoint1.xValue = [NSNumber numberWithInteger:0];
    dataPoint1.yValue = [NSNumber numberWithDouble:85];
    [graph.dataForPlot addObject:dataPoint1];
    
    SChartRadialDataPoint *dataPoint2 = [[SChartRadialDataPoint alloc] init];
    dataPoint2.xValue = [NSNumber numberWithInteger:1];
    dataPoint2.yValue = [NSNumber numberWithDouble:15.0];
    [graph.dataForPlot addObject:dataPoint2];
    
/*    SChartRadialDataPoint *dataPoint3 = [[SChartRadialDataPoint alloc] init];
    dataPoint3.xValue = [NSNumber numberWithInteger:2];
    dataPoint3.yValue = [NSNumber numberWithDouble:8.0];
    [graph.dataForPlot addObject:dataPoint3];
    
    SChartRadialDataPoint *dataPoint4 = [[SChartRadialDataPoint alloc] init];
    dataPoint4.xValue = [NSNumber numberWithInteger:3];
    dataPoint4.yValue = [NSNumber numberWithDouble:17.0];
    [graph.dataForPlot addObject:dataPoint4];   */
