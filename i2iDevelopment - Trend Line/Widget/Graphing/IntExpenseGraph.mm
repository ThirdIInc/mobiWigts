...
-(void)readVal {
    ...
    SChartDataPoint *dataPoint1 = [[SChartDataPoint alloc] init];
    dataPoint1.xValue = [NSNumber numberWithInteger:10];
    dataPoint1.yValue = [NSNumber numberWithInteger:50];
    [graph.dataForPlot addObject:dataPoint1];
    
    
    SChartDataPoint *dataPoint2 = [[SChartDataPoint alloc] init];
    dataPoint2.xValue = [NSNumber numberWithInteger:40];
    dataPoint2.yValue = [NSNumber numberWithInteger:80];
    [graph.dataForPlot addObject:dataPoint2];
    
    SChartDataPoint *dataPoint3 = [[SChartDataPoint alloc] init];
    dataPoint3.xValue = [NSNumber numberWithInteger:60];
    dataPoint3.yValue = [NSNumber numberWithInteger:95];
